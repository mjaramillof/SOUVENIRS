...
const Cart = ({ cart, onUpdateCartQty, onRemoveFromCart, onEmptyCart }) => {
  ...
  const renderEmptyCart = () => (
    <Typography variant="subtitle1">No tienes productos en tu carrito,
      <Link className={classes.link} to="/">Comienza añadiendo algo</Link>!
    </Typography>
  );
  ...
  return (
    <Container>
      ...
      <Typography className={classes.title} variant="h3" gutterBottom>Su Carrito de Compras</Typography>
